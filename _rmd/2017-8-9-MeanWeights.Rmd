...
print(xtable(sum1,digits=c(0,0,0,0,0,0,2)),include.rownames=FALSE,comment=FALSE)
```
...
sum2 <- group_by(df,age) %>%
  ...
  mutate(pred.mnwt=exp(loga+b*log(mnlen)),
         diff.mnwt=(pred.mnwt-true.mnwt)/true.mnwt*100) %>%
  as.data.frame()
print(xtable(sum2,digits=c(0,0,0,0,0,0,2)),include.rownames=FALSE,comment=FALSE)
```
...
sum3 <- group_by(df,age) %>%
  ...
  mutate(pred.mnwt=exp(loga+b*log(mnlen)),
         diff.mnwt=(pred.mnwt-true.mnwt)/true.mnwt*100) %>%
  as.data.frame()
print(xtable(sum3,digits=c(0,0,0,0,1,1,2)),include.rownames=FALSE,comment=FALSE)
```
...
sum4 <- group_by(df,age) %>%
  ...
  mutate(pred.mnwt=exp(loga+b*log(mnlen)),
         diff.mnwt=(pred.mnwt-true.mnwt)/true.mnwt*100) %>%
  as.data.frame()
print(xtable(sum4,digits=c(0,0,0,0,0,0,2)),include.rownames=FALSE,comment=FALSE)
```
...
sum5 <- group_by(df,age) %>%
  ...
  mutate(pred.mnwt=exp(loga+b*log(mnlen)),
         diff.mnwt=(pred.mnwt-true.mnwt)/true.mnwt*100) %>%
  as.data.frame()
print(xtable(sum5,digits=c(0,0,0,0,0,0,2)),include.rownames=FALSE,comment=FALSE)
```

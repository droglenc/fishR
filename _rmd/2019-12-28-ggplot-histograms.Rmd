...
source("rmd2md.R")
rmd2md("2019-12-28-ggplot-histograms")
```
...
```{r hist2,fig.width=4.5,fig.height=3,par1=TRUE}
...
```{r hist3a,fig.width=7,fig.height=3,par1=TRUE}
...
```{r hist3b,fig.width=7,fig.height=3,par1=TRUE}
...
```{r hist4,fig.width=7,fig.height=7,par1=TRUE}
